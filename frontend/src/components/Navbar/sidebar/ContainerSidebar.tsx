...
const ContainerSidebar: React.FC<ContainerSidebarProps> = ({ userName,currentPath, showDiv, pathName, name }) => {
    ...
    return (
        <li className={`relative group p-4 flex justify-center items-center
            ...
            <a href={`/user/${userName}/${pathName}`} className="text-white"> {name} </a>
        </li>
    );
};
