...
export class AdminService {
     ...
     * Topup
     */
    public static adminTopup<ThrowOnError extends boolean = false>(options: Options<AdminTopupData, ThrowOnError>) {
        return (options?.client ?? client).post<AdminTopupResponse, AdminTopupError, ThrowOnError>({
            ...options,
            url: '/admin/topup'
        });
    }
...
export class InstanceService {
     ...
     */
    public static instanceGetInstanceConsoleBuffer<ThrowOnError extends boolean = false>(options: Options<InstanceGetInstanceConsoleBufferData, ThrowOnError>) {
        return (options?.client ?? client).get<InstanceGetInstanceConsoleBufferResponse, InstanceGetInstanceConsoleBufferError, ThrowOnError>({
            ...options,
            url: '/instance/{instance_name}/console-buffer'
        });
    }
     ...
     */
    public static instanceResetInstancePassword<ThrowOnError extends boolean = false>(options: Options<InstanceResetInstancePasswordData, ThrowOnError>) {
        return (options?.client ?? client).post<InstanceResetInstancePasswordResponse, InstanceResetInstancePasswordError, ThrowOnError>({
            ...options,
            url: '/instance/{instance_name}/reset-password'
        });
    }
